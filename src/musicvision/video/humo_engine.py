...
# Negative prompt — translated from original HuMo Chinese config,
# with "too many background people" removed (breaks arena/crowd scenes).
_NEGATIVE_PROMPT = (
    "oversaturated colors, overexposed, static, blurry details, subtitles, "
    "overall grayish, worst quality, low quality, JPEG artifacts, ugly, "
    "deformed, extra fingers, poorly drawn hands, poorly drawn face, "
    "disfigured, malformed limbs, fused fingers, frozen frame, "
